...
```python
json_pattern1 = os.path.join(os.getcwd(),'purchase_data.json')
json_pattern2 = os.path.join(os.getcwd(),'purchase_data2.json')

#json1 = getJSON(json_pattern1)
#json2 = getJSON(json_pattern2)

pd.read_json(json_pattern1)
